...
DROP TABLE IF EXISTS import_geojson."Imported_Lines" CASCADE;

CREATE TABLE IF NOT EXISTS import_geojson."Imported_Lines"
AS 
SELECT * FROM import_geojson."MedialAxis_LineString"
...
ALTER TABLE import_geojson."Imported_Lines"
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY;

CREATE INDEX IF NOT EXISTS Imported_Lines_geom_idx
  ON import_geojson."Imported_Lines"
  USING GIST (geom);
  
DROP TABLE IF EXISTS import_geojson."Imported_Bays" CASCADE;

CREATE TABLE import_geojson."Imported_Bays"
AS 
SELECT * FROM import_geojson."MedialAxis_LineString"
...
ALTER TABLE import_geojson."Imported_Bays"
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY;

CREATE INDEX IF NOT EXISTS Imported_Bays_geom_idx
  ON import_geojson."Imported_Bays"
  USING GIST (geom);
...
UPDATE import_geojson."Imported_Lines" r
...
UPDATE import_geojson."Imported_Bays" r
SET "RestrictionTypeID" = l."BayLineTypeCode"
FROM import_geojson."RestrictionTypes_Lookup" l
WHERE l."geojson_restriction_type_name" = r."Restriction_type_names";
...
UPDATE import_geojson."Imported_Bays" As p
	SET "RestrictionTypeID"=l."BayLineTypeCode"
	FROM import_geojson."RestrictionTypes_Lookup" l
	WHERE l."geojson_restriction_type_code" = p."Restriction_type_codes";
	
UPDATE import_geojson."Imported_Lines" As p
	SET "RestrictionTypeID"=l."BayLineTypeCode"
	FROM import_geojson."RestrictionTypes_Lookup" l
	WHERE l."geojson_restriction_type_code" = p."Restriction_type_codes";
